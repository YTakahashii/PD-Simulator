...
namespace Simulator
{
    /*飛脚宅急便。サイズ160cm,サイズ30kgまで*/
    public partial class Sagawa
    {
        public csvReader cr;
        public int row, col;
        ...
        public string name = "飛脚宅急便　 ";
        private const int ERROR_NUM = 99999;
        private const string ERROR_STR = "ERROR";
        public int[] cool = { 162, 162, 270, 324,0,0 }; //60,80,100,140
        private int _charge;
        public int charge
        {
            get { return _charge; }
        ...
        public Sagawa(string sender_comboBox, string receiver_comboBox, double sumlength_textBox, double weight_textBox)
        {
        ...
        public bool Init(bool usecool)
        {
            ...
            if (sender_text == "沖縄" && receiver_text != "沖縄"){
                errorMessage += "飛脚宅急便では沖縄県は県内のみのサービスです。";
                errorflg = true;
            }
           ...
           if (DecisonRowLength(sumlength) == ERROR_NUM){
            ...
            if(errorflg){
                ...
                cr = new csvReader(CurrentDir + "/charge/SAGAWA/" + DecisionTable(sender_text) + ".csv", encode);
                if(usecool){
